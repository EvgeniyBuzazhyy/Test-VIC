...
// --- This fragment show variants answers in question9 ---
public class Fragment9 extends Fragment4 implements onSomeEventListener
{
//------------------------------- Creating a View, which will track the content, and give his system
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState)
    {
        View v =  inflater.inflate(R.layout.fragment9, null);
...
//-------------------------------------------------------------------------- View more not available
    public void onDestroyView()
    {
        ...
        someEventListener.seveData(11,ans);
    }
}